...
/// 8 (domain) + 8 (epoch) + 8 (group) = 56 bytes.
pub const SNAPSHOT_SIGN_MESSAGE_SIZE: usize = 24;
...
mod tests {
    ...
    fn test_domain_tag() {
        ...
        assert_eq!(SNAPSHOT_SIGN_DOMAIN_TAG, b"SNAPSHOT");
    }

    #[test]
    fn test_message_roundtrip() {
        let msg = SnapshotSignMessage::new(
            EpochNumber(12345),
            SpoolGroup(7),
        );
    ...
    fn test_different_epochs_produce_different_messages() {
        let msg1 = SnapshotSignMessage::new(
            EpochNumber(1),
            SpoolGroup(3),
        );
        let msg2 = SnapshotSignMessage::new(
            EpochNumber(2),
            SpoolGroup(3),
        );
    ...
    #[test]
    fn test_domain_separation_from_write() {
        let msg1 = SnapshotSignMessage::new(
            EpochNumber(42),
            SpoolGroup(9),
        );
        ...
        assert_ne!(&msg1.to_bytes()[0..8], &msg2.to_bytes()[0..8]);
    }
}
