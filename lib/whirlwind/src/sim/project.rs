...
mod tests {
    ...
    // each preset reports the group count its genesis starts with
    #[test]
    fn preset_groups() {
    ...
    // rounds per epoch follow the epoch slots over the round cadence
    #[test]
    fn cadence_rounds() {
    ...
    // the projected totals agree with the measured per-round inputs
    #[test]
    ...
    // the projected proof size is the sampled sub-leaf plus both merkle paths
    #[test]
    fn response_bytes() {
