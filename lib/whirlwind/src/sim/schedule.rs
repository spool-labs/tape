...
mod tests {
    ...
    // round base slots sit on a fixed grid across epochs
    #[test]
    fn interval_grid() {
    ...
    // every preset epoch length yields a legal cadence
    #[test]
    fn preset_cadence() {
    ...
    // a schedule whose rounds would overlap their neighbours is rejected
    #[test]
    fn interval_width() {
    ...
    // every round finds an entropy block when production is certain
    #[test]
    ...
    // every round is void when no slot ever produces a block
    #[test]
    fn no_production() {
    ...
    // the entropy block always lands inside the round's span
    #[test]
    fn entropy_slot() {
