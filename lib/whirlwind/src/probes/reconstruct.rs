...
//!
//! A free-rider that stored nothing runs the real repair path and recovers the
...
pub struct ReconstructReport {
    ...
    /// Repair traffic as a multiple of the chunk it restores. This is
    /// d/(d-k+1) for a minimum-storage regenerating code, which is 1.6
...
/// Repair ratio for a minimum-storage regenerating code.
