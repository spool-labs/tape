...
/// Creates a new program account with discriminator.
#[inline(always)]
...
/// Creates a new program account with a custom size and discriminator.
#[inline(always)]
...
/// Resizes an account to a new size, transferring rent if needed.
#[inline(always)]
