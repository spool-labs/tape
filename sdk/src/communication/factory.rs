...
use tape_node_client::{NodeError, NodeClient, NodeClientBuilder};
...
pub struct NodeCommunicationFactory {
    ...
    cache: Arc<RwLock<HashMap<String, NodeClient>>>,
}
...
impl NodeCommunicationFactory {
    ...
    pub fn client_for_address(&self, address: &str) -> Result<NodeClient, NodeError> {
