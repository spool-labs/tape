...
fn unexpected_peer_response(request: &PeerReq) -> PeerRes {
    match request {
        ...
        PeerReq::PushSnapshotWriteSig(_) => PeerRes::PushSnapshotWriteSig(Err(unexpected_error())),
        PeerReq::PushSnapshotFinalizeSig(_) => PeerRes::PushSnapshotFinalizeSig(Err(unexpected_error())),
...
fn setup() -> Fixture {
    ...
    let api = Arc::new(MemoryApi::new({
        ...
        move |_node, req| match req {
            ...
            PeerReq::PushSnapshotWriteSig(_) => unexpected_peer_response(&req),
            PeerReq::PushSnapshotFinalizeSig(_) => unexpected_peer_response(&req),
