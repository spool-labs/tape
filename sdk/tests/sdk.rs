...
fn unexpected_peer_response(request: &PeerReq) -> PeerRes {
    match request {
        ...
        PeerReq::GetSnapshotWriteSig(_) => PeerRes::GetSnapshotWriteSig(Err(unexpected_error())),
        PeerReq::GetSnapshotFinalizeSig(_) => PeerRes::GetSnapshotFinalizeSig(Err(unexpected_error())),
...
fn setup() -> Fixture {
    ...
    let api = Arc::new(MemoryApi::new({
        ...
        move |_node, req| match req {
            ...
            PeerReq::GetSnapshotWriteSig(_) => unexpected_peer_response(&req),
            PeerReq::GetSnapshotFinalizeSig(_) => unexpected_peer_response(&req),
