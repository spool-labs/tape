...
fn unexpected_peer_response(request: &PeerReq) -> PeerRes {
    match request {
        ...
        PeerReq::SnapshotWrite(_) => PeerRes::SnapshotWrite(Err(unexpected_error())),
        PeerReq::SnapshotFinalize(_) => PeerRes::SnapshotFinalize(Err(unexpected_error())),
...
fn setup() -> Fixture {
    ...
    let api = Arc::new(MemoryApi::new({
        ...
        move |_node, req| match req {
            ...
            PeerReq::SnapshotWrite(_) => unexpected_peer_response(&req),
            PeerReq::SnapshotFinalize(_) => unexpected_peer_response(&req),
