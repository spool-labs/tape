...
pub async fn stats<Db: Store, Cluster: Api, Blockchain: Rpc>(
    ...
    Ok(Json(NodeStats {
        ...
        sync_bytes_fetched: metrics.sync_bytes_fetched,
        repair_bytes_fetched: metrics.repair_bytes_fetched,
        recover_bytes_fetched: metrics.recover_bytes_fetched,
