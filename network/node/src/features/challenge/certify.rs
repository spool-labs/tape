...
/// Sweeps every banked round for a quorum that filled while settlement was off.
///
...
mod tests {
    ...
    // while settlement was off is claimed by nothing unless the resume sweeps for
