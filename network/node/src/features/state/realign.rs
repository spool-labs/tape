...
use crate::features::http::handlers::challenge::certify_banked;
    ...
    Blockchain: Rpc + 'static,
{
    ...
    tokio::spawn(async move {
        ...
        // Swept before the suspension lifts, so the round path sees the verified
        // certificate rather than settling a miss over a provisional claim.
        certify_banked(&context).await;
    });
}
